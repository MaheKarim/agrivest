...
<div class="col-sm-6 col-lg-4">
    <article class="card card--blog">
        <a href="{{ route('blog.details', $blog->slug) }}" class="card-thumb">
            <img src="{{ frontendImage('blog', 'thumb_'.$blog->data_values->image, '416x268') }}" alt="{{ __($blog->data_values->title) }}">
        </a>
        <div class="card-body">
            <h6 class="card-title">
            ...
            <a class="btn btn--sm btn--outline" href="{{ route('blog.details', $blog->slug) }}">@lang('Read More')</a>
        </div>
    </article>
</div>
@endforeach
