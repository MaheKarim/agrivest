...
@section('content')
    <section class="contact-page">
        <div class="contact-page-top py-120">
            <div class="container">
                <div class="row gy-4 justify-content-between align-items-start">
                    <div class="col-lg-4">
                        <div class="contact-headings">
                            <h5 class="contact-headings__title">@lang('Contact with Us')</h5>
                            <p class="contact-headings__subtitle">@lang("Don't hesitate to reach out if you need assistance or information of any sort. We're here to help.")</p>
                        </div>
                        ...
                        <div class="card custom--card">
                            <div class="card-body">
                                <form class="contact-form verify-gcaptcha" method="post">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-sm-6">
                                            <label class="form-label form--label required" for="username">Full Name</label>
                                        ...
                                        <div class="col-sm-6">
                                            <label class="form-label form--label required" for="username">Email</label>
                                        ...
                                        <div class="col-sm-12">
                                            <label class="form-label form--label required" for="username">Subject</label>
                                            <input name="subject" type="text" class="form-control form--control"
                                                value="{{ old('subject') }}" required placeholder="@lang('Subject')">
                                        </div>
                                        <div class="col-sm-12">
                                            <label class="form-label form--label required" for="username">Message</label>
